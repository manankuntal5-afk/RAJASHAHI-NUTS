...
import { OrderAddress, OrderConfirmation, ActivePage } from './types';
...
// Static imports for instant, reliable page navigation without dynamic chunk load errors
...
export default function App() {
  ...
  // Navigation handler that updates state and URL hash without reload
  ...
  return (
    <div className="min-h-screen bg-[#061810] text-[#f7f3eb] font-sans antialiased selection:bg-[#dfba5d] selection:text-[#082218]">
      {/* ROUTING: Render either Sub-Page or Home Page */}
      {activePage === 'privacy-policy' ? (
        <PrivacyPolicyPage
          onHomeClick={() => handleNavigate('home')}
          onOrderClick={handleOpenOrderPayment}
        ...
        <>
          ...
          <Header onOrderClick={handleOpenOrderPayment} onHomeClick={() => handleNavigate('home')} />
          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
              ...
              <div className="lg:col-span-5 flex flex-col gap-5">
                ...
                <div className="flex items-center gap-2 text-xs sm:text-sm text-[#e2d9c8]">
                  ...
                  <span className="text-gray-400">
                    ({PRODUCT_DATA.totalReviews.toLocaleString('en-IN')} Customer Reviews)
                  </span>
                </div>
            ...
            {/* NOTE: FaqSection has been removed from Home Page and moved to dedicated FAQ Page as requested! */}
          </main>

          {/* Footer with 9-Page Navigation */}
          <Footer activePage={activePage} onHomeClick={() => handleNavigate('home')} onNavigate={handleNavigate} />
        </>
      )}

      {/* Sticky Bottom Bar with Order Now Button */}
      <StickyBottomBar onOrderClick={handleOpenOrderPayment} onHomeClick={() => handleNavigate('home')} />

      {/* Dedicated Online Payment Modal (Appears upon clicking Order Now from ANY page) */}
      {isPaymentOpen && (
        <OnlinePaymentModal
